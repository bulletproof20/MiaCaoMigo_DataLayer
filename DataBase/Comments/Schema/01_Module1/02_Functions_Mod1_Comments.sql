...
-- =========================================================
-- tfn_block_clock_in_if_absent
-- =========================================================

comment on function tfn_block_clock_in_if_absent() is
...
comment on function tfn_block_inactivate_if_clock_active() is
'prevents employee inactivation while an active clock-in session without end timestamp exists';



-- =========================================================
-- tfn_block_assistant_if_veterinarian_exists
-- =========================================================

comment on function tfn_block_assistant_if_veterinarian_exists() is
'enforces role disjunction by preventing assignment of assistant role to employees already registered as veterinarians';



-- =========================================================
-- tfn_block_veterinarian_if_assistant_exists
-- =========================================================

comment on function tfn_block_veterinarian_if_assistant_exists() is
'enforces role disjunction by preventing assignment of veterinarian role to employees already registered as assistants';



-- =========================================================
-- tfn_block_absence_overlap_by_user
-- =========================================================

comment on function tfn_block_absence_overlap_by_user() is
