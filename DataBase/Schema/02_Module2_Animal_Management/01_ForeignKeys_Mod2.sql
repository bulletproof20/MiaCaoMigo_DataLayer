...
-- breed → species
alter table breed drop constraint if exists fk_breed_species;
alter table breed
...
alter table animal drop constraint if exists fk_animal_species;
alter table animal
...
alter table animal drop constraint if exists fk_animal_breed;
alter table animal
...
alter table ownership drop constraint if exists fk_ownership_animal;
alter table ownership
...
alter table ownership drop constraint if exists fk_ownership_employee;
alter table ownership
...
alter table concession drop constraint if exists fk_concession_entity;
...
alter table concession drop constraint if exists fk_concession_employee;
alter table concession
...
alter table concession drop constraint if exists fk_concession_animal;
alter table concession
...
alter table delivery drop constraint if exists fk_delivery_entity;
...
alter table delivery drop constraint if exists fk_delivery_animal;
alter table delivery
...
alter table delivery_employee drop constraint if exists fk_del_emp_delivery;
...
alter table delivery_employee drop constraint if exists fk_del_emp_employee;
alter table delivery_employee
